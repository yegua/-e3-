      ...
      success: function(res){
        ...
        console.log(datalist);
         if(datalist.success==true){
            ...
            wx.setStorageSync('userDetail', JSON.stringify({ employeeName: userDetail.employeeName, sitename: userDetail.sitename, funclist: userDetail.funclist, sitecode: userDetail.sitecode})); 
            wx.switchTab({
              url:"/pages/index/index"    
            }); 
         }else{
           util.showMsg('登录失败！',false);
         };     
