...
var expressCompany = require('../../../utils/expressCompany.js');
Page({
  ...
  data: {
    ...
    bHeight: 0,
    startPageY: 0,
    contents: expressCompany._expressCompany,
    billcode: ''
  },
  ...
  selectCustomer: function (e) {
    ...
    var _code = this.data.billcode;
    wx.redirectTo({
      url: '/pages/query/kuaijiangz/kuaijiangz?billcode=' + _code + '&type=' + e.currentTarget.dataset.type + '&name=' + e.currentTarget.dataset.name
    });
  },
